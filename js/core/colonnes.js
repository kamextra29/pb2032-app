...
// Bijective base-26 conversion: Excel column letter to 1-based index
export function lettreVersIndex(lettre) {
  let index = 0;
  for (let i = 0; i < lettre.length; i++) {
    const code = lettre.charCodeAt(i) - 64; // A=1, B=2, ..., Z=26
    index = index * 26 + code;
  }
  return index;
}

// Bijective base-26 conversion: 1-based index to Excel column letter
...
export const COLONNES = [
  ...
  { lettre: 'L', cle: 'idCoffret', libelle: 'ID coffret', zone: 'ignoree', type: 'texte' },
  { lettre: 'M', cle: 'plan', libelle: 'Plan', zone: 'ignoree', type: 'texte' },
  { lettre: 'N', cle: 'commentairePrecision', libelle: 'Commentaire / précision', zone: 'ignoree', type: 'texte' },
  ...
  { lettre: 'W', cle: 'codeBarreCompteur', libelle: 'Code barre compteur', zone: 'ignoree', type: 'texte' },
  { lettre: 'X', cle: 'typeClient2', libelle: 'Type client2', zone: 'ignoree', type: 'texte' },
  { lettre: 'Y', cle: 'emplacementRegulateur', libelle: 'Emplacement regulateur', zone: 'ignoree', type: 'texte' },
  { lettre: 'Z', cle: 'codeBarreRegulateur', libelle: 'Code barre regulateur', zone: 'ignoree', type: 'texte' },
  { lettre: 'AA', cle: 'sigleCabRegulateur', libelle: 'Sigle code barre fictif régulateur', zone: 'ignoree', type: 'texte' },
  { lettre: 'AB', cle: 'cabFictif', libelle: 'Code barre fictif avec tous les chiffres', zone: 'ignoree', type: 'texte' },
  { lettre: 'AC', cle: 'anneeRegulateur', libelle: 'Année regulateur', zone: 'ignoree', type: 'texte' },
  { lettre: 'AD', cle: 'changementRegulateur', libelle: 'Changement de régulateur = noter 1', zone: 'ignoree', type: 'texte' },
  ...
  { lettre: 'AO', cle: 'statutPb', libelle: 'Statut branchement PB 2032', zone: 'ignoree', type: 'texte' },
];
...
export const ZONES = {
  ...
  ignorees: COLONNES.filter(c => c.zone === 'ignoree').map(c => c.lettre),
};
